...
def get_conversational_chain():
    prompt_template = """
    Answer the question from the context in points by rephrasing it , dont provide the answer as it is. GIVE ANSWER ONLY IN POINTS LEAVING A LINE BETWEEN EACH POINTS!,TRANSLATE THE ANSWER TO HINDI FIRST AND THEN ANSWER IT. if the answer is not in
